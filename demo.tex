...
Table~\ref{tab:pebble} demonstrates our current all-hex meshing capability up to 11,145 pebbles 
using 3.5 million spectral elements and their averaged walltime per timestep from flow simulations 
up to time $=7$. % involving 14000--15750 time steps.  
\begin{table}
  \centering
  ...
  \hline
%  146 & 62,132 & 425 & 2 & 12 & 5177 & 2.6M &  N/A    \\
...
%  146 & 62,132 & 425 & 2 & 12 & 5177 & 2.6M & 14,000 timesteps & -- \\
%  1568 & 524,386 & 334 & 28 & 168 & 3121 & 1.5M & 14,000       & 5735.58  \\
%  3260 & 1,121,214 & 343 & 50 & 300 & 3737 & 1.9M & 15,750     & 11855.54  \\  %% <--- 15750= 7k (5e-4) + 8750 (4e-4) 
%  11145 & 3,575,076 & 320 & 148 & 888 & 4025 & 2.0M & 14,000    & 12639.43  \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \hline \hline
  \end{tabular}
